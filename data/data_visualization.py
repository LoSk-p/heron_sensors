...
class DataVisualization:
    ...
    def __post_init__(self): 
        ...
        with open(self.filename, 'r') as f:
            for line in f:
                ...
                self.location.append((float(line["lat"]), float(line["lon"])))
    ...
    def drawing(self):
        ...
        # folium.CircleMarker(location=[self.lat, self.lon], radius=1).add_to(map)

        folium.Choropleth(
            geo_data=Polygon([self.location]),
